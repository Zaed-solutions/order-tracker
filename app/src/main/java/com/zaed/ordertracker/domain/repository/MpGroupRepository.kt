...
interface MpGroupRepository {
    ...
    suspend fun getMasterPackagesByFlightId(flightId: String): Flow<Result<List<MasterPackage>>>
    suspend fun getMasterPackagesByGroupId(groupId: String): Flow<Result<List<MasterPackage>>>
